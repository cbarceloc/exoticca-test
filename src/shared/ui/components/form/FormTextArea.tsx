        ...
        <div className={`w-full ${className}`}>
          ...
          <div className="relative">
            ...
            <textarea
              ...
              border-0 rounded-xl py-1.5  shadow-sm ring-1 dark:ring-gray-500 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6 dark:bg-gray-800 dark:text-white ${
                !!fieldState.error &&
